// FORK-CUSTOM: 助手详情页 fork 版本的 Section 原语组件（SectionCard / FieldLabel / ConfigRow / ReadonlySelectionField）。
// 从上游 AssistantSettings/editor/editorSectionPrimitives.tsx 深度复制而来，供 XaiworkAssistantEditor 独立演进。
