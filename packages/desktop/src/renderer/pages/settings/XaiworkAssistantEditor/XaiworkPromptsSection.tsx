// FORK-CUSTOM: 助手详情页 fork 版本的「推荐提示词」区块。深度复制自上游 AssistantSettings/editor/PromptsSection.tsx。
...
const XaiworkPromptsSection: React.FC<PromptsSectionProps> = ({
  isReadOnly,
...
export default XaiworkPromptsSection;
