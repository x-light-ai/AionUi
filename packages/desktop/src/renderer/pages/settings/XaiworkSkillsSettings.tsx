// FORK-CUSTOM: XAIWork 定制版"我的技能"页面（替代上游 SkillsHubSettings 的重写实现）。
...
interface XaiworkSkillsSettingsProps {
  /** When false, renders without SettingsPageWrapper — useful for embedding in a tab */
  withWrapper?: boolean;
}

const XaiworkSkillsSettings: React.FC<XaiworkSkillsSettingsProps> = ({ withWrapper = true }) => {
...
export default XaiworkSkillsSettings;
