...
type XaiworkAssistantListPanelProps = {
  ...
  const renderList = (sectionAssistants: AssistantListItem[]) => (
    <div className='rounded-12px border border-border-2 bg-2 p-8px md:rounded-16px md:p-10px'>
      <DndContext sensors={sensors} collisionDetection={closestCenter} onDragEnd={handleSectionDragEnd}>
        <SortableContext items={sectionAssistants.map((a) => a.id)} strategy={verticalListSortingStrategy}>
...
export default XaiworkAssistantListPanel;
